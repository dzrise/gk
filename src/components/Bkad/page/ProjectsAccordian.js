        ...
        return (
            <div style={styleCard}>
                <div className="accordian">
                    <AccordianItem class="slide-one" isActive={this.state.active === 0}  onClickFunc={() =>this.handleClick(0)} zIndex={4}>
                    ...
                    <AccordianItem class="slide-two" isActive={this.state.active === 1} onClickFunc={() =>this.handleClick(1)} zIndex={3}>
                    ...
                    <AccordianItem class="slide-three" isActive={this.state.active === 2}  onClickFunc={() =>this.handleClick(2)} zIndex={2}>
                    ...
                    <AccordianItem class="slide-four" isActive={this.state.active === 3}  onClickFunc={() =>this.handleClick(3)} zIndex={1}>
